'use babel'; // eslint-disable-line
import { View } from 'atom-space-pen-views'
// import { View, TextEditorView } from 'atom-space-pen-views'
// import { CompositeDisposable } from 'atom'
// import buildTextEditor from './build-text-editor'
...
class PanelView extends View {
  ...
  content () {
    console.log('I just render the PanelView', this.props)
    this.div(() => {
      this.h1('atom-jq is rendered! :yay:')
    })
  }
}
